...
const projects = [

    {
        ...
        description: "web-based system for real-time sensor monitoring and control with gyroscope, color, and pressure sensors, featuring live data updates and LED control.",
